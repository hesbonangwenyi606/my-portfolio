...
// // Memoized Icon Component with Color-Shift (No changes here)
// const Icon = memo(({ icon: IconComp, title, color }: any) => (
//   <motion.div
//     className="relative group"
//     initial={{ filter: 'hue-rotate(0deg)' }}
...
//   // Typewriter effect (No changes here)
//   useEffect(() => {
//     const currentRole = `Hi, I'm a ${roles[roleIndex]}`;
//     const timer = setTimeout(() => {
//       const adjustedSpeed = speed + (isMobile ? -20 : 0);
...
//     <section className="min-h-screen bg-[url('https://i.pinimg.com/1200x/cd/76/d7/cd76d793c30eb1d8afdb9193ce0b8984.jpg')] bg-cover bg-center bg-fixed flex items-center justify-center px-4 relative">
...
//       <div className="absolute inset-0 bg-gradient-to-br from-slate-900/95 via-blue-900/90 to-slate-800/80" />

//       {/* CHANGE 3: Added 'relative' and 'z-10' to this container to lift all the content above the new overlay. */}
//       <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">

//         {/* Left Text (No changes inside this div) */}
//         <div className="text-white space-y-3 md:space-y-4 z-5 relative">
//           <h1 className="text-2xl md:text-2xl font-bold leading-tight whitespace-nowrap">
//             <span className="text-blue-200">Hesbon Angwenyi</span>
//           </h1>
...
//         {/* Floating Profile Image (No changes inside this div) */}
//         <motion.div
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ delay: 0.6, duration: 0.6 }}
...
//   SiMongodb, SiPostgresql, SiMysql, SiFirebase, SiKubernetes, SiNextdotjs,
//   SiTailwindcss, SiRuby, SiJavascript, SiTypescript, SiC, SiCplusplus, SiExpress,
//   SiZoho // 1. Imported the Zoho icon
// } from 'react-icons/si';

// // 3. Updated component to use full class names for better reliability
// const Icon = memo(({ icon: IconComp, title, hoverColor }: any) => (
//   <motion.div
//     className="relative group"
//     initial={{ filter: 'hue-rotate(0deg)' }}
//     animate={{ filter: ['hue-rotate(0deg)', 'hue-rotate(360deg)'] }}
...
//     <IconComp
//       title={title}
//       className={`text-gray-300 ${hoverColor} transition-transform duration-300 hover:scale-110`}
//     />
//     <motion.div
//       className="absolute w-2 h-2 bg-white rounded-full opacity-0"
//       initial={{ opacity: 0, scale: 0 }}
...
//   // 2. Added Zoho CRM to the list and updated all icons to use `hoverColor`
//   const techIcons = [
//     { icon: FaPython, title: "Python", hoverColor: "hover:text-yellow-400" },
//     { icon: FaJava, title: "Java", hoverColor: "hover:text-red-500" },
//     { icon: FaPhp, title: "PHP", hoverColor: "hover:text-indigo-400" },
//     { icon: FaHtml5, title: "HTML5", hoverColor: "hover:text-orange-500" },
//     { icon: FaCss3Alt, title: "CSS3", hoverColor: "hover:text-blue-400" },
//     { icon: SiJavascript, title: "JavaScript", hoverColor: "hover:text-yellow-300" },
//     { icon: SiTypescript, title: "TypeScript", hoverColor: "hover:text-sky-400" },
//     { icon: FaReact, title: "React", hoverColor: "hover:text-blue-400" },
//     { icon: SiNextdotjs, title: "Next.js", hoverColor: "hover:text-white" },
//     { icon: FaAngular, title: "Angular", hoverColor: "hover:text-red-500" },
//     { icon: FaVuejs, title: "Vue.js", hoverColor: "hover:text-green-400" },
//     { icon: FaNodeJs, title: "Node.js", hoverColor: "hover:text-green-500" },
//     { icon: SiExpress, title: "Express.js", hoverColor: "hover:text-gray-300" },
//     { icon: SiTailwindcss, title: "Tailwind CSS", hoverColor: "hover:text-sky-400" },
//     { icon: SiMongodb, title: "MongoDB", hoverColor: "hover:text-green-500" },
//     { icon: SiPostgresql, title: "PostgreSQL", hoverColor: "hover:text-sky-500" },
//     { icon: SiMysql, title: "MySQL", hoverColor: "hover:text-blue-400" },
//     { icon: FaDocker, title: "Docker", hoverColor: "hover:text-blue-400" },
//     { icon: SiKubernetes, title: "Kubernetes", hoverColor: "hover:text-sky-500" },
//     { icon: FaAws, title: "AWS", hoverColor: "hover:text-orange-400" },
//     { icon: SiFirebase, title: "Firebase", hoverColor: "hover:text-yellow-400" },
//     { icon: SiZoho, title: "Zoho CRM", hoverColor: "hover:text-red-500" }, // Zoho icon added here
//     { icon: FaGitAlt, title: "GitHub", hoverColor: "hover:text-red-400" },
//     { icon: FaLinux, title: "Linux", hoverColor: "hover:text-orange-500" },
//     { icon: FaRust, title: "Rust", hoverColor: "hover:text-orange-400" },
//     { icon: SiRuby, title: "Ruby", hoverColor: "hover:text-red-400" },
//     { icon: SiC, title: "C", hoverColor: "hover:text-blue-400" },
//     { icon: SiCplusplus, title: "C++", hoverColor: "hover:text-blue-400" },
//   ];
...
//               transition={{ x: { repeat: Infinity, repeatType: 'loop', duration: iconScrollDuration, ease: 'linear' } }}
//             >
//               {iconsLayer1.map((t, i) => <Icon key={`l1-${i}`} {...t} />)}
//             </motion.div>
//             <motion.div
//               className="absolute flex gap-10 text-6xl md:text-7xl top-12 opacity-80"
//               animate={{ x: ['-50%', '0%'] }}
//               transition={{ x: { repeat: Infinity, repeatType: 'loop', duration: iconScrollDuration, ease: 'linear' } }}
//             >
//               {iconsLayer2.map((t, i) => <Icon key={`l2-${i}`} {...t} />)}
//             </motion.div>
//             {!isMobile && particles.map((p, i) => (
//               <motion.div
//                 key={i}
...
// // Using the more robust hoverColor prop
// const Icon = memo(({ icon: IconComp, title, hoverColor }: any) => (
//   <motion.div
//     className="relative group"
//     initial={{ filter: 'hue-rotate(0deg)' }}
...
//     { icon: FaAws, title: "AWS", hoverColor: "hover:text-orange-400" },
//     { icon: SiFirebase, title: "Firebase", hoverColor: "hover:text-yellow-400" },
//     { icon: SiZoho, title: "Zoho CRM", hoverColor: "hover:text-red-500" },
//     { icon: FaGitAlt, title: "GitHub", hoverColor: "hover:text-red-400" },
//     { icon: FaLinux, title: "Linux", hoverColor: "hover:text-orange-500" },
//     { icon: FaRust, title: "Rust", hoverColor: "hover:text-orange-400" },
//     { icon: SiRuby, title: "Ruby", hoverColor: "hover:text-red-400" },
...
//   // CHANGE 2: Repeat the array three times to ensure it's long enough
//   const mobileIconSet = techIcons.slice(0, 15);
//   const iconsLayer1 = isMobile ? [...mobileIconSet, ...mobileIconSet, ...mobileIconSet] : [...techIcons, ...techIcons, ...techIcons];
//   const iconsLayer2 = isMobile ? [...mobileIconSet.reverse(), ...mobileIconSet, ...mobileIconSet] : [...techIcons.reverse(), ...techIcons, ...techIcons];
...
//   // CHANGE 3: Increased duration to match the longer track
//   const iconScrollDuration = isMobile ? 45 : 90;
...
//           </div>
//           <div className="overflow-hidden relative h-24 w-full mt-12 z-10">
//             {/* CHANGE 1 & 3: Reduced size, gap, and updated animation properties */}
//             <motion.div
//               className="absolute flex gap-8 text-4xl md:text-5xl"
//               animate={{ x: ['0%', '-33.33%'] }}
//               transition={{ x: { repeat: Infinity, repeatType: 'loop', duration: iconScrollDuration, ease: 'linear' } }}
//             >
//               {iconsLayer1.map((t, i) => <Icon key={`l1-${i}`} {...t} />)}
//             </motion.div>
//             <motion.div
//               className="absolute flex gap-8 text-4xl md:text-5xl top-12 opacity-80"
//               animate={{ x: ['-33.33%', '0%'] }}
//               transition={{ x: { repeat: Infinity, repeatType: 'loop', duration: iconScrollDuration, ease: 'linear' } }}
//             >
//               {iconsLayer2.map((t, i) => <Icon key={`l2-${i}`} {...t} />)}
