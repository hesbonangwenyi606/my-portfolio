<footer className="relative bg-gray-900 text-white py-6 overflow-hidden font-sans">
  ...
  <div className="max-w-6xl mx-auto px-4 opacity-0 animate-fade-up space-y-6">
    <div className="grid md:grid-cols-5 gap-6 text-center md:text-left">
      ...
      <div className="flex flex-col items-center md:items-start">
        <a
          ...
          className="relative w-28 h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 mb-2 group rotate-logo"
        >
      ...
      {/* Quick Links */}
      <div>
        <h3 className="text-lg font-heading font-semibold mb-2">Quick Links</h3>
      ...
      {/* Services */}
      <div>
        <h3 className="text-lg font-heading font-semibold mb-2">Services</h3>
      ...
      {/* QR Code */}
      <div className="flex flex-col items-center md:items-end md:ml-6 mt-3 md:mt-0">
        <h3 className="text-lg font-heading font-semibold mb-1">Scan to WhatsApp</h3>
        <a
