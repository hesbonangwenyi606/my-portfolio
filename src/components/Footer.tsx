...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gray-900 text-white py-10 overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full opacity-20 gradient-float-1 -z-10" />
      <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full opacity-20 gradient-float-2 -z-10" />
      <div className="absolute top-1/2 right-1/2 w-72 h-72 rounded-full opacity-10 gradient-float-3 -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-4 animate-fade-up space-y-8">
        <div className="grid md:grid-cols-5 gap-6 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            <button
              ...
              className="relative w-32 h-32 mb-3 group rotate-logo"
            >
              <div className="absolute inset-0 rounded-full static-rect" />
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Full-Stack & DevOps Intern passionate about building modern web
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-gray-300">
              ...
              <li>Cloud Deployment (Basic)</li>
              <li>Backend Development (Junior)</li>
            </ul>
          </div>
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          {socialLinks.map(({ icon: Icon, href, label }) => (
            ...
            >
              <div className="rotating-circle absolute inset-0 rounded-full" />
              <div className="relative z-10 w-11 h-11 rounded-full bg-gray-900 flex items-center justify-center hover:scale-110 transition">
